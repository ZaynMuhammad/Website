export const projects = [
  {
    title: "Weather App",
    description:
      "Created a weather app to display the temperature of a city. Designed using React, HTML, CSS, and API provided from OpenWeather",
    image: "/images/WeatherAppImg.png",
    tags: ["React", "HTML5", "CSS", "Javascript"],
    source: "https://weatherapp-zayn.netlify.app/",
    visit: "https://github.com/ZaynMuhammad/WeatherApp",
    id: 0,
  },
  {
    title: "Library App",
  ...
  },
  {
    title: "Chat App",
    description:
      "Join the same room in two seperate tabs to chat with others. The goal of the project was to try out Socket.IO and practice using some Typescript with React. To try out this app, make sure to join the same room on two seperate tabs or on seperate computers.",
    image: "/images/4.png",
