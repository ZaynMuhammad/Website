export const projects = [
  ...
  },
  {
    title: "Chat App",
    description:
      "Join the same room in two seperate tabs to chat with others. To try out this app, make sure to join the same room on two seperate tabs or on seperate computers.",
    image: "/images/4.png",
